package com.sup.itg.itgt.java.customView.zhizhutu;
...
public class RadarViewbak1 extends View {
    ...
    public RadarViewbak1(Context context) {
        this(context, null);
    }

    public RadarViewbak1(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mRadius = Math.min(mCenterX - textWidth - mTextSpace, mCenterY - textHeight - mTextSpace);
    ...
    private void drawAngelName(Canvas canvas) {
        ...
        for (int i = 0; i < mEdgeNum; i++) {
            ...
            x = mCenterX + (radius + mTextSpace) * sin;
            y = mCenterY - (radius + mTextSpace) * cos;
            ...
            if (sin > 0) {
                if (cos>0){
                    ItgL.e("sin > 0,cos>0 "+i);
                    canvas.drawText(text, x+mTextSpace, y+textHeight/4, mAngeNamePaint);
                }else {
                    ItgL.e("sin > 0,cos<0 "+i);
                    canvas.drawText(text, x+mTextSpace, y+textHeight/4, mAngeNamePaint);
                }
                ...
                if (cos>0){
                    ItgL.e("sin < 0,cos>0 "+i);
                    canvas.drawText(text, x - textWidth-mTextSpace, y+textHeight/4, mAngeNamePaint);
                }else {
                    ItgL.e("sin < 0,cos<0 "+i);
                    canvas.drawText(text, x - textWidth-mTextSpace, y+textHeight/4, mAngeNamePaint);
