...
public abstract class ItgHeaderScrollingViewBehavior extends ItgViewOffsetBehavior<View> {
    public final Rect tempRect1 = new Rect();
    public final Rect tempRect2 = new Rect();
    private int verticalLayoutGap = 0;
    private int overlayTop;

    public ItgHeaderScrollingViewBehavior() {
    }

    public ItgHeaderScrollingViewBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public boolean onMeasureChild(CoordinatorLayout parent, View child, int parentWidthMeasureSpec, int widthUsed, int parentHeightMeasureSpec, int heightUsed) {
        ...
        if (childLpHeight == -1 || childLpHeight == -2) {
            ...
            if (header != null) {
                ...
                int heightMeasureSpec = MeasureSpec.makeMeasureSpec(height, childLpHeight == -1 ? MeasureSpec.EXACTLY : MeasureSpec.AT_MOST);
