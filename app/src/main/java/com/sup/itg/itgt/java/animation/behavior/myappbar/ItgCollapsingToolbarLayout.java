...
public class ItgCollapsingToolbarLayout extends FrameLayout {
    ...
    public ItgCollapsingToolbarLayout(Context context) {
        this(context, (AttributeSet)null);
    }

    public ItgCollapsingToolbarLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }


    public ItgCollapsingToolbarLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new androidx.core.view.OnApplyWindowInsetsListener() {
            public WindowInsetsCompat onApplyWindowInsets(View v, WindowInsetsCompat insets) {
                return ItgCollapsingToolbarLayout.this.onWindowInsetChanged(insets);
            }
        });
    }
    ...
    protected void onAttachedToWindow() {
        ...
        if (parent instanceof AppBarLayout) {
            ...
            if (this.onOffsetChangedListener == null) {
                this.onOffsetChangedListener = new ItgCollapsingToolbarLayout.OffsetUpdateListener();
            }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mode == 0 && topInset > 0) {
            heightMeasureSpec = MeasureSpec.makeMeasureSpec(this.getMeasuredHeight() + topInset, MeasureSpec.EXACTLY);
            super.onMeasure(widthMeasureSpec, heightMeasureSpec);
        }
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        if (this.lastInsets != null) {
            ...
            for(int n = this.getChildCount(); z < n; ++z) {
        ...
        if (this.collapsingTitleEnabled && this.dummyView != null) {
            this.drawCollapsingTitle = ViewCompat.isAttachedToWindow(this.dummyView) && this.dummyView.getVisibility() ==  View.VISIBLE;
    ...
    static ItgViewOffsetHelper getViewOffsetHelper(View view) {
        ItgViewOffsetHelper offsetHelper = (ItgViewOffsetHelper)view.getTag(id.view_offset_helper);
        if (offsetHelper == null) {
            offsetHelper = new ItgViewOffsetHelper(view);
        ...
        if (this.scrimAnimator == null) {
            ...
            this.scrimAnimator.addUpdateListener(new AnimatorUpdateListener() {
                public void onAnimationUpdate(ValueAnimator animator) {
                    ItgCollapsingToolbarLayout.this.setScrimAlpha((Integer)animator.getAnimatedValue());
                }
            });
    ...
    public void setStatusBarScrim(@Nullable Drawable drawable) {
        if (this.statusBarScrim != drawable) {
            ...
            if (this.statusBarScrim != null) {
                ...
                this.statusBarScrim.setVisible(this.getVisibility() == View.VISIBLE, false);
    ...
    protected boolean checkLayoutParams(ViewGroup.LayoutParams p) {
        return p instanceof ItgCollapsingToolbarLayout.LayoutParams;
    }

    protected ItgCollapsingToolbarLayout.LayoutParams generateDefaultLayoutParams() {
        return new ItgCollapsingToolbarLayout.LayoutParams(-1, -1);
    }

    public FrameLayout.LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new ItgCollapsingToolbarLayout.LayoutParams(this.getContext(), attrs);
    }

    protected FrameLayout.LayoutParams generateLayoutParams(ViewGroup.LayoutParams p) {
        return new ItgCollapsingToolbarLayout.LayoutParams(p);
    }
    ...
    final int getMaxOffsetForPinChild(View child) {
        ItgViewOffsetHelper offsetHelper = getViewOffsetHelper(child);
        ItgCollapsingToolbarLayout.LayoutParams lp = (ItgCollapsingToolbarLayout.LayoutParams)child.getLayoutParams();
    ...
    private class OffsetUpdateListener implements AppBarLayout.OnOffsetChangedListener {
        ...
        public void onOffsetChanged(AppBarLayout layout, int verticalOffset) {
            ItgCollapsingToolbarLayout.this.currentOffset = verticalOffset;
            int insetTop = ItgCollapsingToolbarLayout.this.lastInsets != null ? ItgCollapsingToolbarLayout.this.lastInsets.getSystemWindowInsetTop() : 0;
            int expandRange = 0;

            for(int z = ItgCollapsingToolbarLayout.this.getChildCount(); expandRange < z; ++expandRange) {
                View child = ItgCollapsingToolbarLayout.this.getChildAt(expandRange);
                ItgCollapsingToolbarLayout.LayoutParams lp = (ItgCollapsingToolbarLayout.LayoutParams)child.getLayoutParams();
                ItgViewOffsetHelper offsetHelper = ItgCollapsingToolbarLayout.getViewOffsetHelper(child);
                switch(lp.collapseMode) {
                    case 1:
                        offsetHelper.setTopAndBottomOffset(MathUtils.clamp(-verticalOffset, 0, ItgCollapsingToolbarLayout.this.getMaxOffsetForPinChild(child)));
                        break;
                    case 2:
            ...
            ItgCollapsingToolbarLayout.this.updateScrimVisibility();
            if (ItgCollapsingToolbarLayout.this.statusBarScrim != null && insetTop > 0) {
                ViewCompat.postInvalidateOnAnimation(ItgCollapsingToolbarLayout.this);
            }

            expandRange = ItgCollapsingToolbarLayout.this.getHeight() - ViewCompat.getMinimumHeight(ItgCollapsingToolbarLayout.this) - insetTop;
            ItgCollapsingToolbarLayout.this.collapsingTextHelper.setExpansionFraction((float)Math.abs(verticalOffset) / (float)expandRange);
        }
    }
