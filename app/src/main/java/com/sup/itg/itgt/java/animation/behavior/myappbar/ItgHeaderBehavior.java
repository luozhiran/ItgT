...
public abstract class ItgHeaderBehavior<V extends View> extends ItgViewOffsetBehavior<V> {
    ...
    public ItgHeaderBehavior() {
    }

    public ItgHeaderBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public final boolean fling(CoordinatorLayout coordinatorLayout, V layout, int minOffset, int maxOffset, float velocityY) {
        ...
        if (this.scroller.computeScrollOffset()) {
            this.flingRunnable = new ItgHeaderBehavior.FlingRunnable(coordinatorLayout, layout);
    ...
    private class FlingRunnable implements Runnable {
        ...
        public void run() {
            if (this.layout != null && ItgHeaderBehavior.this.scroller != null) {
                if (ItgHeaderBehavior.this.scroller.computeScrollOffset()) {
                    ItgHeaderBehavior.this.setHeaderTopBottomOffset(this.parent, this.layout, ItgHeaderBehavior.this.scroller.getCurrY());
                    ViewCompat.postOnAnimation(this.layout, this);
                } else {
                    ItgHeaderBehavior.this.onFlingFinished(this.parent, this.layout);
                }
            }
